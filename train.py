...
class Trainer(object):
    ...
    def __init__(self, args):
        ...
        if args.cuda:
           self.modeling = self.modeling.cuda()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_name', type=str, default='model.pkl', help="the name of model weight")
    parser.add_argument('--dataset_root', type=str, default='./data/mvtec_anomaly_detection', help="dataset root")
    parser.add_argument('--experiment_dir', type=str, default='./experiment/experiment_1', help="experiment dir root")
    parser.add_argument('--classname', type=str, default='capsule', help="the subclass of the datasets")
    ...
    parser.add_argument("--topk", type=float, default=0.1, help="normal class in cifar10")
